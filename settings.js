...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝐒𝐔𝐋𝐀-𝐌𝐃=MrdG1RRa#NBogZ_YN1UTszYoih7k-DanycS6YB8SgEHbZUA7N4Z0' : process.env.SESSION_ID,
...
NEWS_SEND_JID: process.env.NEWS_SEND_JID === undefined ? "false" : process.env.NEWS_SEND_JID,
